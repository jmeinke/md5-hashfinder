...
inline void MD5::FF(uint32_t *a, uint32_t b, uint32_t c, uint32_t d,
  uint32_t x, uint32_t s, uint32_t ac) {
  *a = rotate_left(*a + F(b, c, d) + x + ac, s) + b;
}

inline void MD5::GG(uint32_t *a, uint32_t b, uint32_t c, uint32_t d,
  uint32_t x, uint32_t s, uint32_t ac) {
  *a = rotate_left(*a + G(b, c, d) + x + ac, s) + b;
}

inline void MD5::HH(uint32_t *a, uint32_t b, uint32_t c, uint32_t d,
  uint32_t x, uint32_t s, uint32_t ac) {
  *a = rotate_left(*a + H(b, c, d) + x + ac, s) + b;
}

inline void MD5::II(uint32_t *a, uint32_t b, uint32_t c, uint32_t d,
  uint32_t x, uint32_t s, uint32_t ac) {
  *a = rotate_left(*a + I(b, c, d) + x + ac, s) + b;
}

// default constructor, just reset
MD5::MD5() {
  reset();
}

// nifty shortcut constructor, compute MD5 for string
// and finalize it right away
...
void MD5::apply(const uint8_t block[kBlocksize]) {
