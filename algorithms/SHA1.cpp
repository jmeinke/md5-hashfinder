...
// Authors: Steve Reid <steve@edmweb.com>
// - Original C Code
// Authors: Bruce Guenter <bruce@untroubled.org>
// - Changes to fit into bglibs
// Authors: Volker Grabsch <vog@notjusthosting.com>
// - Translation to simpler C++
/*
===============================================================================
...
// nifty shortcut constructor, compute SHA1 for string
...
void SHA1::apply(uint32_t block[BLOCK_BYTES]) {
...
void SHA1::read(std::istream *is, std::string *s, const int kMax) {
  char sbuf[kMax];
  (*is).read(sbuf, kMax);
